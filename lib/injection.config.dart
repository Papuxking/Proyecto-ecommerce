...
import 'package:ecommerce_flutter/src/data/dataSource/remote/services/UsersService.dart'
    as _i4;
import 'package:ecommerce_flutter/src/di/AppModule.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i7.AddressService>(() => appModule.addressService);
    gh.factory<_i8.AddressRepository>(() => appModule.addressRepository);
    gh.factory<_i9.ProductsService>(() => appModule.productsService);
    gh.factory<_i10.ProductsRepository>(() => appModule.productsRepository);
    gh.factory<_i11.SharedPref>(() => appModule.sharedPref);
    gh.factory<_i12.CategoriesRepository>(() => appModule.categoriesRepository);
    gh.factory<_i13.AuthRepository>(() => appModule.authRepository);
    gh.factory<_i14.AuthUseCases>(() => appModule.authUseCases);
    gh.factory<_i15.UsersUseCases>(() => appModule.usersUseCases);
    gh.factory<_i16.ShoppingBagRepository>(
        () => appModule.shoppingBagRepository);
    gh.factory<_i17.AddressUseCases>(() => appModule.addressUseCases);
    gh.factory<_i18.CategoriesUseCases>(() => appModule.categoriesUseCases);
    gh.factory<_i19.ProductsUseCases>(() => appModule.productsUseCases);
    gh.factory<_i20.ShoppingBagUseCases>(() => appModule.shoppingBagUseCases);
    return this;
  }
}
