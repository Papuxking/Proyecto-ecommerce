...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.MercadoPagoService>(() => appModule.mercadoPagoService);
    gh.factory<_i7.MercadoPagoRepository>(
    ...
    gh.factory<_i10.AddressService>(() => appModule.addressService);
    gh.factory<_i11.AuthRepository>(() => appModule.authRepository);
    gh.factory<_i12.OrdersService>(() => appModule.ordersService);
    ...
    gh.factory<_i16.ProductsRepository>(() => appModule.productsRepository);
    gh.factory<_i17.ShoppingBagRepository>(
        () => appModule.shoppingBagRepository);
    gh.factory<_i18.AddressRepository>(() => appModule.addressRepository);
    gh.factory<_i19.AuthUseCases>(() => appModule.authUseCases);
    gh.factory<_i20.UsersUseCases>(() => appModule.usersUseCases);
    gh.factory<_i21.CategoriesUseCases>(() => appModule.categoriesUseCases);
    gh.factory<_i22.ProductsUseCases>(() => appModule.productsUseCases);
    gh.factory<_i23.ShoppingBagUseCases>(() => appModule.shoppingBagUseCases);
    gh.factory<_i24.AddressUseCases>(() => appModule.addressUseCases);
    gh.factory<_i25.MercadoPagoUseCases>(() => appModule.mercadoPagoUseCases);
    gh.factory<_i26.OrdersUseCases>(() => appModule.ordersUseCases);
    return this;
  }
}
